      ...
      >
        ...
        <div className={cn(
          ...
          <div className={cn(
            ...
            {collapsed ? (
              <p className="hidden md:block" title="TechFlow Solutions v1.0">TF</p>
            ) : (
              <>
                <p>TechFlow Solutions</p>
                <p>Data Automation v1.0</p>
              </>
            )}
            <p className="md:hidden">TechFlow Solutions</p>
            <p className="md:hidden">Data Automation v1.0</p>
          </div>
        </div>
      </aside>
    </>
